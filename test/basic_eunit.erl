...
start()->
    ...
    {ok,PodNode,PodDir}=host_sim:start(),
    
    ok=rpc:call(PodNode,pod_server,load_start_appl,["divi_app","0.1.0"],2*5000),
    5.0=rpc:call(PodNode,mydivi,divi,[10,2],5000),

      ok=rpc:call(PodNode,pod_server,stop_unload_appl,["divi_app","0.1.0"],2*5000),
    {badrpc,_}=rpc:call(PodNode,mydivi,divi,[10,2],5000),
